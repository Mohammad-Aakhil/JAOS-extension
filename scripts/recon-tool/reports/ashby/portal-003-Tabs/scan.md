...
- **URL**: https://jobs.ashbyhq.com/Tabs/a305abb8-306b-4c47-a547-493c952712c9/application
- **Hostname**: jobs.ashbyhq.com
- **Scanned**: 2026-03-18T05:43:02.503Z
- **Frameworks**: React
...
### Sections
- `<h1>` Senior Technical Talent Acquisition Partner
- `<h2>` Location
- `<h2>` Employment Type
- `<h2>` Location Type
- `<h2>` Department
...
### Iframes
- id="" name="a-loeeolrm9wu2" src="https://www.recaptcha.net/recaptcha/api2/anchor?ar=1&k=6LeFb_YUAAAAALUD5h-BiQEp8JaFChe0e0A6r49Y&co=a"
- id="" name="" src=""
...
| 4 | Main Page | - | combobox | no | `-` | `#form > div._jobPostingForm_oj0x8_399.ashby-application-form` |
| 5 | Main Page | Linkedin Profile URL | text | YES | `140e280d-4f2f-4818-b80c-b54bfe4100be` | `#\31 40e280d-4f2f-4818-b80c-b54bfe4100be` |
...
- **Required**: no
- **Classes**: `_input_v5ami_28`
- **Selector**: `#form > div._jobPostingForm_oj0x8_399.ashby-application-form-container:nth-of-type(2) > div._section_oj0x8_87.ashby-application-form-section-container > fieldset._container_nh65k_29._fieldEntry_17tft_29 > div._inputContainer_v5ami_28 > input._input_v5ami_28`
- **Typeahead/autocomplete**: YES
- **Note**: Typeahead/autocomplete detected
- **Note**: DOM changed significantly after interaction (+2768 chars)
- **Parent chain**: `div` → `fieldset` → `div`
<details>
<summary>Raw HTML (container)</summary>

```html
<fieldset class="_container_nh65k_29 _fieldEntry_17tft_29"><label class="_heading_101oc_53 _required_101oc_92 _label_17tft_43 ashby-application-form-question-title" for="6cb641e6-f028-41d7-a431-f8ae38697170">How many years of experience do you have as an internal recruiter?</label><div class="_inputContainer_v5ami_28"><input class="_input_v5ami_28" placeholder="Start typing..." aria-autocomplete="list" aria-expanded="false" aria-haspopup="listbox" role="combobox" value=""><button class="_container_pjyt6_1 _toggleButton_v5ami_32"><svg viewBox="0 0 448 512" fill="none" height="1em"><path d="M207.029 381.476L12.686 187.132C3.313 177.759 3.313 162.563 12.686 153.191L35.353 130.524C44.71 121.167 59.875 121.149 69.254 130.484L224 284.505L378.745 130.484C388.124 121.149 403.289 121.167 412.646 130.524L435.313 153.191C444.686 162.564 444.686 177.76 435.313 187.132L240.971 381.476C231.598 390.848 216.402 390.848 207.029 381.476Z"></path></svg></button></div></fieldset>
```
</details>
...
- **Type**: text
- **Tag**: `<input>`
- **ID**: `140e280d-4f2f-4818-b80c-b54bfe4100be`
- **Name**: `140e280d-4f2f-4818-b80c-b54bfe4100be`
- **Placeholder**: "Type here..."
- **Required**: YES
- **Classes**: `_input_1wkz4_28 _input_17tft_33`
- **Selector**: `#\31 40e280d-4f2f-4818-b80c-b54bfe4100be`
- **Parent chain**: `div` → `div` → `div`
<details>
<summary>Raw HTML (container)</summary>

```html
<div class="_fieldEntry_17tft_29 ashby-application-form-field-entry"><label class="_heading_101oc_53 _required_101oc_92 _label_17tft_43 ashby-application-form-question-title" for="140e280d-4f2f-4818-b80c-b54bfe4100be">Linkedin Profile URL</label><div><input placeholder="Type here..." name="140e280d-4f2f-4818-b80c-b54bfe4100be" required="" id="140e280d-4f2f-4818-b80c-b54bfe4100be" type="text" class="_input_1wkz4_28 _input_17tft_33" value=""></div></div>
```
</details>
