...
- **URL**: https://jobs.ashbyhq.com/zettabyte-space/7dbb7b3a-90e0-4983-8833-6dfc5a451edb/application
- **Hostname**: jobs.ashbyhq.com
- **Scanned**: 2026-03-18T06:03:53.110Z
- **Frameworks**: React
...
### Iframes
- id="" name="a-irtp18bflils" src="https://www.recaptcha.net/recaptcha/api2/anchor?ar=1&k=6LeFb_YUAAAAALUD5h-BiQEp8JaFChe0e0A6r49Y&co=a"
- id="" name="" src=""
...
| 4 | Main Page | Have you worked for start-up company as  | text | YES | `7715e54f-2724-42a5-b585-a6422d94a988` | `#\37 715e54f-2724-42a5-b585-a6422d94a988` |
...
### Field 4: Have you worked for start-up company as HR Manager/Lead or Office Manager? If yes, what is name of the company?

- **Type**: text
- **Tag**: `<input>`
- **ID**: `7715e54f-2724-42a5-b585-a6422d94a988`
- **Name**: `7715e54f-2724-42a5-b585-a6422d94a988`
- **Placeholder**: "Type here..."
- **Required**: YES
- **Classes**: `_input_1wkz4_28 _input_17tft_33`
- **Selector**: `#\37 715e54f-2724-42a5-b585-a6422d94a988`
- **Parent chain**: `div` → `div` → `div`
<details>
<summary>Raw HTML (container)</summary>

```html
<div class="_fieldEntry_17tft_29 ashby-application-form-field-entry"><label class="_heading_101oc_53 _required_101oc_92 _label_17tft_43 ashby-application-form-question-title" for="7715e54f-2724-42a5-b585-a6422d94a988">Have you worked for start-up company as HR Manager/Lead or Office Manager? If yes, what is name of the company?</label><div><input placeholder="Type here..." name="7715e54f-2724-42a5-b585-a6422d94a988" required="" id="7715e54f-2724-42a5-b585-a6422d94a988" type="text" class="_input_1wkz4_28 _input_17tft_33" value=""></div></div>
```
</details>
